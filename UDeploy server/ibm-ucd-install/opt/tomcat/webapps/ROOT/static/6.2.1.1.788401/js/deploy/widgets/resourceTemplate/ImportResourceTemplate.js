...
function(
    ...
    return declare([_Widget, _TemplatedMixin], {
            ...
            this.connectionSelector = new CloudConnectionSelect(
                {
                    ...
                    onChange: function(cloudConnectionId) {
                        ...
                        self.form.addField({
                            name: "isVsys",
                            label: i18n("Use VSys.Next patterns"),
                            description: "Check this box to use a Virtual System pattern in IBM PureApplication System version 2.0 or later.",
                            type: "Checkbox",
                            value: false,
                        ...
                        self.showCloudResourceField(cloudConnectionId);
                    }
                }
            );
            this.form.addField({
        ...
        showCloudResourceField: function(cloudConnectionId, isVsysNext) {
            var self = this;
