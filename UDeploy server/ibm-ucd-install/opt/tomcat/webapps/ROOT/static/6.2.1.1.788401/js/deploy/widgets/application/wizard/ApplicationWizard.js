...
function (
    ...
    return declare([Wizard, _BlockerMixin], {
        ...
        _setupFullWizard: function() {
            ...
            // Grow the first page.
            this.firstPage.domNode.style.width = "700px";
            ...
            // Reach into the fieldlist on the first page and make the labels wider.  Hackish.
            query(".labelsAndValues-labelCell", this.firstPage.domNode).style({
                width: "250px"
            });
            ...
            this.addedPanes.push(newPane({
                style:"height: " + paneHeightPx + "; width: 700px;",
        ...
        _disableWizard: function() {
            ...
            // Reach into the fieldlist on the first page and reset the label width.  Hackish.
            query(".labelsAndValues-labelCell", this.firstPage.domNode).style({
                width: "240px"
            });
