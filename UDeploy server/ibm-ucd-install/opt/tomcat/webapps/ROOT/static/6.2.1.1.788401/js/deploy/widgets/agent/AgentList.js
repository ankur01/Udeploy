...
function(
    ...
    return declare(
                    ...
                    load: function(jsonData) {
                        ...
                        self.viewSelect = new Select({
                            options: [{
                                ...
                                label: i18n("By Tag"),
                                value: "agent/all/sort?sort=tag"
                            },{
                                label: i18n("By Team"),
                                value: "agent/all/sort?sort=team"
                            }],
                            sortByLabel: false,
                            style: {
        ...
        getCreateActions: function(item) {
            ...
            if ((bootstrap.serverLicenseType === "SERVER_AUTHORIZED" ||
                    bootstrap.serverLicenseBackupType === "SERVER_AUTHORIZED" ) &&
        ...
        showConnectionTest: function(target) {
            ...
            var resultBox = new Textarea({style:"min-height:5em; height: 100px; width: 400px;"});
