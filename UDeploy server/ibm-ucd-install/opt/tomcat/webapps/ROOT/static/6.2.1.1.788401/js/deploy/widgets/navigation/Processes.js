...
function(dojo,
    ...
    config.data.tabSets.push({
        ...
        getDetailTitle: function() {
            return i18n("Process: %s", appState.process.name.escape());
        },
        getDetailFields: function() {
            ...
            detailProperties.push({
                label: i18n("Version"),
                value: i18n("%s of %s", appState.process.version, appState.process.versionCount)
            });
    
            detailProperties.push({
                label: "",
                value: util.vc.generateVersionControls(appState.process, function(version) {
                    return "process/"+appState.process.id+"/"+version;
                })
            });
        ...
        getDetailDescription: function() {
            return entities.encode(appState.process.description);
        },
