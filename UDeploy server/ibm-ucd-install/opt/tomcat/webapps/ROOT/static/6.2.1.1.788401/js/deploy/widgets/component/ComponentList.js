 ...
 */
    return declare('deploy.widgets.application.ComponentList',
        [_Widget, _TemplatedMixin],
        {
            ...
            _views: {
                ...
                tag: {
                    ...
                    getChildUrl: function (tag) {
                        return bootstrap.restUrl + "deploy/component";
                    },
                ...
                team: {
                    ...
                    getChildUrl: function(team) {
                        return bootstrap.restUrl + "deploy/component/team/" + team.id;
                    },
                    baseFilters: [],
                ...
                return {
                    ...
                    getFilterFields: function() {
                        ...
                        result.push(new TextBox({
                            ...
                            "class": "filter",
                            style: { "width": "45%" },
                            placeHolder: self.currentView === "basic" ? i18n("Component Name") : i18n("Name"),
                            type: "like"
                        }));
             ...
             * create permission.
             */
            getRowCreateActions: function(item) {
                var self = this;
                return [{
                    label: i18n("Copy"),
                    onClick: function() {
            ...
            actionsFormatter: function(item) {
                ...
                if (config.data.permissions[security.system.createComponents]) {
                    array.forEach(self.getRowCreateActions(item), function(action) {
            ...
            showNewComponentDialog: function(source) {
                ...
                var newComponentDialog = new Dialog({
                    ...
                    closable: true,
                    draggable: true,
                    description: i18n("When you create a component, you identify the source and define how the artifacts are brought into IBM UrbanCode Deploy.")
                });
