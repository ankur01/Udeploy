...
function(dojo,
    ...
    config.data.tabSets.push({
        ...
        getDetailFields: function() {
            ...
            detailProperties.push({
                label: i18n("Version"),
                value: i18n("%s of %s", appState.componentProcess.version, appState.componentProcess.versionCount)
            });

            detailProperties.push({
                label: "",
                value: util.vc.generateVersionControls(appState.componentProcess, function(version) {
                    return "componentProcess/"+appState.componentProcess.id+"/"+version;
                })
            });
        ...
        getDetailDescription: function() {
            return entities.encode(appState.componentProcess.description);
        },
