            ...
            array.forEach(sources, function(source){
                ...
                if (allowDnd) {
                    if (_this.optionsSwitch.value) {
                        ...
                        // I had to make this inelegant fix in order to support a fix for 6.2.0.0 where
                        // Japanese characters were wrapping on the User Preferences page.
                        if (dojo.body().getAttribute("lang") === "ja") {
                            propDefsForm.formContainer.labelStyle.width = "300px";
                        }
