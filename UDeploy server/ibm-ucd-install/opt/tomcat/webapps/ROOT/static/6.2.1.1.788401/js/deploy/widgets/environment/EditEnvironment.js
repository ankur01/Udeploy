        ...
        return declare([_Widget, _TemplatedMixin], {
            ...
            postCreate: function() {
                ...
                this.form = new ColumnForm({
                    ...
                    showButtons: this.environment || this.source,
            ...
            _handleUcdBlueprints: function(value) {
                ...
                var resourceSelect = new ResourceSelector({
                    url: bootstrap.restUrl + "resource/resource/creatableFolderTree",
                    childUrlBase: bootstrap.restUrl + "resource/resource/creatableFolderTreeChildren/",
                    tableConfigKey: null
                });
                if (!self.form.hasField("baseResourceId")) {
                    self.form.addField({
            ...
            showCleanupFields: function(template) {
                ...
                if (!initialCleanupDaysToKeep) {
                    initialCleanupDaysToKeep = 0;
                }
                var initialCleanupCountToKeep = this.existingValues.cleanupCountToKeep;
                if (!initialCleanupCountToKeep) {
                    initialCleanupCountToKeep = 0;
                }
            ...
            showHistoryCleanupFields: function(template) {
                ...
                var initialEnableProcessHistoryCleanup = this.existingValues.enableProcessHistoryCleanup;
                ...
                this.form.addField({
                    ...
                    description: i18n("Select to use deployment history cleanup " +
                        ...
                        "values that you set."),
                    value: initialEnableProcessHistoryCleanup,
                    textDir: "ltr",
                    type: "Checkbox",
                    readOnly: !!template,
                ...
                if (initialEnableProcessHistoryCleanup) {
            ...
            showUseSystemDefaultDays: function(show, template){
                var self = this;
                if (show) {
                    var initalUseSystemDefaultDays = this.existingValues.useSystemDefaultDays;
                    this.form.addField({
                        ...
                        value: initalUseSystemDefaultDays,
                        textDir: "ltr",
                        type: "Checkbox",
                        readOnly: !!template,
                        onChange : function(value){
            ...
            showHistoryCleanupDaysToKeep: function(show, template){
                if (show) {
                    var initialHistoryCleanupDaysToKeep = this.existingValues.historyCleanupDaysToKeep;
                    this.form.addField({
                        ...
                        value: initialHistoryCleanupDaysToKeep,
                        required: true,
                        textDir: "ltr",
                        type: "Number",
                        readOnly: !!template
            ...
            addSettingsFields: function(template) {
                ...
                self.form.addField({
                    ...
                    label: i18n("Use Default Component Cleanup Settings"),
                    readOnly: !!template,
                    description: i18n("When selected, this environment uses the component version " +
                            "cleanup  settings for the system or component settings, if available.  " +
                            "Clear to provide values for all components in this environment."),
                    type: "Checkbox",
                    onChange: function(value) {
                        if (!value) {
