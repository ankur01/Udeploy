...
function(dojo,
    ...
    config.data.tabSets.push({
        ...
        breadcrumbs: ["home", "topLevelTab", "resource"],
        selectedTopLevelTab: "resources",
    ...
    //config.data.tabSets.push({
    //    id: "resourceRole",
    //    hashPattern: ["resourceRole", "tab"],
    //    breadcrumbs: ["home", "topLevelTab", "resourceRoles", "resourceRole"],
    //    selectedTopLevelTab: "resources",
    //
    //    getDetailTitle: function() {
    //        return i18n("Role: %s", entities.encode(appState.resourceRole.name));
    //    },
    //    getDetailDescription: function() {
    //        return entities.encode(appState.resourceRole.description);
    //    },
    //
    //    stateCalls: [{
    //        targetAppStateEntry: "resourceRole",
    //        getUrl: function(appStateTargets, newAppState) {
    //            return bootstrap.restUrl+"resource/resourceRole/"+appStateTargets.resourceRole;
    //        }
    //    }],
    //
    //    defaultTab: "resources",
    ...
    //        view: "deploy/views/resourceRole/resourceRoleResources"
    //    },{
    //        id: "configuration",
    //        label: i18n("Configuration"),
    //        className: "configurationTab",
    //        view: "deploy/views/resourceRole/resourceRoleConfiguration"
    //    }]
    //});
    ...
    config.data.tabSets.push({
        ...
        hashPattern: ["leftResource", "rightResource", "tab"],
        breadcrumbs: ["home", "topLevelTab"],
        selectedTopLevelTab: "resources",
        ...
        stateCalls: [{
            ...
            getUrl: function(appStateTargets, newAppState) {
                return bootstrap.restUrl+"resource/resource/"+appStateTargets.leftResource;
            }
        },{
            targetAppStateEntry: "rightResource",
            getUrl: function(appStateTargets, newAppState) {
                return bootstrap.restUrl+"resource/resource/"+appStateTargets.rightResource;
            }
        }],
