    ...
    return declare('deploy.widgets.agent.EditAgentInstallProps',  [_Widget, _TemplatedMixin], {
        ...
        postCreate: function() {
            ...
            this.form.addField({
                ...
                type: "Text",
                textDir: "ltr",
                value: agentDir || (self.type === SSH ? "/opt/ibm-ucd/agent" : "C:\\Program Files\\agent"),
            ...
            this.form.addField({
                ...
                description: i18n("Path to Java on the target. In many cases, you can use the value of the JAVA_HOME system variable.")
            });
            ...
            if (self.type === "winrs") {
                ...
                this.form.addField({
                    ...
                    type: "Text",
                    value: serviceName || "ibm-ucdagent",
