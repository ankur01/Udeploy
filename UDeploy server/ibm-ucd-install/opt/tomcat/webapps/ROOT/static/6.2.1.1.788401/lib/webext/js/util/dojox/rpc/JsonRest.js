...
*/
dojo.provide("js.util.dojox.rpc.JsonRest");

//dojo.require("dojox.json.ref"); // this provides json indexing which screws us if we dont like it
dojo.require("js.util.dojox.json.ref"); // jaw 2010-11-03 - our replacement for ref.js
	...
	jr = js.util.dojox.rpc.JsonRest={
		...
		sendToServer: function(actions, kwArgs){
			...
			for(i =0; i < actions.length;i++){ // iterate through the actions to execute
				...
				js.util.dojox.rpc.JsonRest._contentId = action.content && action.content.__id; // this is used by OfflineRest
				...
				contentLocation = isPost && js.util.dojox.rpc.JsonRest._contentId;
