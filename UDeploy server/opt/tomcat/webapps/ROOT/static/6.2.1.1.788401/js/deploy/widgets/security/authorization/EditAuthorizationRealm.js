...
function(
    ...
    return declare('deploy.widgets.security.authorization.EditAuthorizationRealm',  [_Widget, _TemplatedMixin], {
        templateString:
        ...
        typeChanged: function(value) {
            ...
            if ("com.urbancode.security.authorization.ldap.LdapAuthorizationModule" === value) {
                ...
                //
                var searchTypeLabel = self.form.addField({
