        ...
        postCreate: function() {
            ...
            this.form.addField({
                ...
                onChange: function(value) {
                    ...
                    if (value === "ZOS") {
                        self.removeSourceConfigField();
                        self.removeAllSourceConfigPropertyFields();
            ...
            this.form.addField({
                ...
                onChange: function(value, item) {
                    ...
                    if(self.componentTemplate !== undefined && item.id !== this.value) {
                        var warningText = "When you change the source configuration of a component template you will" +
