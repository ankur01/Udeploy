        ...
        getLabel: function() {
            ...
            if (!this.initialized) {
                ...
                if (childChildData.component && childChildData.component.deleted) {
                    ...
                    var defaultLabel = i18n("Each Version for %s", childChildData.componentName);
                    result += childChildData.name;
        ...
        showFieldsForComponent: function(propertyForm, component) {
            ...
            if (component) {
                ...
                if (!existingName || (this.selectedComponent &&
                                existingName === i18n("Each Version for %s", this.selectedComponent.name))) {
                    propertyForm.setValue("name", i18n("Each Version for %s", component.name));
                }
