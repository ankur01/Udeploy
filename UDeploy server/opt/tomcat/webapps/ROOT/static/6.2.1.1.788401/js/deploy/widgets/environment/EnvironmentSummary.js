                ...
                var displayTable = function(link) {
                        on(link, "click", function() {
                            ...
                            var componentResourceTable = new TreeTable({
                                getData: function(){
                                    return [item].concat(versions);
                                },
                                serverSideProcessing: false,
                                columns: Formatters.inventoryGridColumnsFormatter(null, hideDialog, true),
                    ...
                    var moreLink = Formatters.moreVersionsLinkFormatter(versions.length, results);
