...
function(
    ...
    var Util = declare(
        ...
        * ********************************************************************/
        ...
        populatePropValueAndLabel: function(properties, propDef) {
            ...
            if (existingObj && existingObj.value) {
    ...
    var handleXhrError = function(error) {
        ...
        if (errorStatus === 401) {
            var dialog = new Dialog({title:"Authentication Error", content:"401: User not authenticated.  Log in to continue."});
            dialog.show();
        }
    };
